...
<body>
            ...
            <div class="company-description">
                ...
                <div class="header-stats-block">
                    <div class="stats-elem">
                        <p class="stats-elem-number">12k<span>+</span></p>
                        <p class="stats-elem-desc">Happy Customers</p>
                    </div>
                    <div class="stats-elem">
                        <p class="stats-elem-number">14k<span>+</span></p>
                        <p class="stats-elem-desc">Awards Winning</p>
                    </div>
                    <div class="stats-elem">
                        <p class="stats-elem-number">5k<span>+</span></p>
    ...
    <main>
        ...
        <section class="services">
            <h2 class="services-title">See how Trulia can help</h2>
            <div class="services-wrapper">
                <div class="services-elem">
                    <img src="images/rent-pic.svg" alt="Аренда недвижимости" class="services-elem-img">
                ...
                <div class="services-elem">
                    <img src="images/see-pic.svg" alt="Смотрите соседние варианты" class="services-elem-img">
                    <h3 class="services-elem-title">See neighborhoods</h3>
                    <p class="services-elem-desc">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Id risus vulputate tortor, risus ut. Viverra viverra aliquam, semper duis a aliquam.</p>
                    <button class="services-elem-btn">Learn more</button>
                </div>
                <div class="services-elem">
                    <img src="images/buy-pic.svg" alt="покупка жилища" class="services-elem-img">
